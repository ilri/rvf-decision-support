...
#Serilalizer
from bulletin.serializers import SendBulletinSerializer

#Services
from bulletin.services import BulletinService

class SendBulletin(generics.GenericAPIView):
    serializer_class = SendBulletinSerializer
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                if BulletinService.send_bulletin(self, request):

                    success_response.update(result = messages.SUCCESS['SEND_REPORT'], code = status.HTTP_200_OK)
