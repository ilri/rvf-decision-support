...
#Serilalizer
from mail_hub.serializers import UpdateEmailGroupSerializer

#Services
from mail_hub.services import MailHub

class UpdateEmailGroup(generics.GenericAPIView):
    serializer_class = UpdateEmailGroupSerializer
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                if  MailHub.update_mail_group(self, request):

                    success_response.update(result = messages.SUCCESS['UPDATED'], code = status.HTTP_200_OK) 
