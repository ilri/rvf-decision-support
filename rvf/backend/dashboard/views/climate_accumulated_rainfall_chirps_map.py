...
#From serices.py
from dashboard.services import ClimateAccumulatedRainfallChirpsService
from base.services import GEEServices
# from base.services import BaseServices

class ClimateAccumulatedRainfallChirpsMap(generics.GenericAPIView):
        ...
        try:
            ...
            if serializer.is_valid():#Validation mentioned into Serializers
                ...
                if clip_data := GEEServices.get_clip_data(self, request, 'no-geometry'):
                    try:
                        result = ClimateAccumulatedRainfallChirpsService.map(self, request, clip_data)
