...
#From serices.py
from dashboard.services import ClimateAccumulatedRainfallService, DashboardServices
from base.services import GEEServices
# from base.services import BaseServices

class ClimateAccumulatedRainfallTimeseries(generics.GenericAPIView):
        ...
        try:
            ...
            if serializer.is_valid():#Validation mentioned into Serializers
                ...
                if clip_data := GEEServices.get_clip_data(self, request, 'geometry'):
                    try:
                        result = ClimateAccumulatedRainfallService.timeseries(self, request, clip_data)
