...
#From serices.py
from dashboard.services import AccumulatedRainfallChirpsService,DashboardServices
from base.services import GEEServices
# from base.services import 

class MeanAccumulatedRainfallChirpsTimeseries(generics.GenericAPIView):
        ...
        try:
            ...
            if serializer.is_valid():#Validation mentioned into Serializers
                ...
                if clip_data := GEEServices.get_clip_data(self, request, 'geometry'):
                    try:
                        result = AccumulatedRainfallChirpsService.mean_rainfall_timeseries(self, request, clip_data)
