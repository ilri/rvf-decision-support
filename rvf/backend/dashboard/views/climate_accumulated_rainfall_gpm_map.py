...
#Serices
from dashboard.services import ClimateAccumulatedRainfallService
from base.services import GEEServices
# from base.services import BaseServices

class ClimateAccumulatedRainfallMap(generics.GenericAPIView):
        ...
        try:
            ...
            if serializer.is_valid():#Validation mentioned into Serializers
                ...
                if clip_data := GEEServices.get_clip_data(self, request, 'no-geometry'):
                    try:
                        result = ClimateAccumulatedRainfallService.map(self, request, clip_data)
